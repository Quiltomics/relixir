...
## Goal
Position R firmly in the high-traffic web tech data world, where stability and performance under massive concurrency and load are a right (not a pay-walled privilege).  

## Roadmap
- [ ] Extend [erserve](https://github.com/del/erserve) from Erlang to Elixir for the purposes of making calls to R from Elixir (where Elixir is like "Erlang++")
